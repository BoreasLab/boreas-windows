...
| [Bootstrap the dev environment](../.agents/skills/bootstrap-windows-dev/SKILL.md) | building and testing the core on a machine with no system .NET, without sudo and without touching $HOME |
